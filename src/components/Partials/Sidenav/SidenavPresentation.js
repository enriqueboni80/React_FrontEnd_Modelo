...
const SideNavPresentation = (props) => {
            ...
            <nav className="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div className="sb-sidenav-menu">
                    <div className="nav">
                        ...
                        <Link to="/" onClick={() => props.setPath("/")} className="nav-link">
                            <div className="sb-nav-link-icon"><i className="fas fa-tachometer-alt"></i></div>Dashboard
                        </Link>

                        <div className="sb-sidenav-menu-heading">DESENVOLVEDOR</div>
                        <Link to="/teste-integracao" onClick={() => props.setPath("/teste-integracao")} className="nav-link">
                            <div className="sb-nav-link-icon"><i className="fas fa-tachometer-alt"></i></div>Teste de intregação
                        </Link>
                        <Link to="/xxx" onClick={(e) => props.redirectTo('https://startbootstrap.com/templates/sb-admin/', e)} className="nav-link">
                            <div className="sb-nav-link-icon"><i className="fas fa-tachometer-alt"></i></div>Template
                        </Link>

                        {/* <div className="sb-sidenav-menu-heading">Interface</div>
                        <Link className="nav-link collapsed" to="/xxx" data-toggle="collapse" data-target="#collapseLayouts"
                        ...
                        <div className="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                            <nav className="sb-sidenav-menu-nested nav"><Link className="nav-link" to="layout-static.html">Static
                            Navigation</Link><Link className="nav-link" to="layout-sidenav-light.html">Light Sidenav</Link></nav>
                        </div>
                        <Link className="nav-link collapsed" to="/xxx" data-toggle="collapse" data-target="#collapsePages"
                        ...
                        {/* <div className="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                            ...
                            <div className="sb-sidenav-collapse-arrow"><i className="fas fa-angle-down"></i></div></Link>
...
export default SideNavPresentation
